sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("vn/com/cateringvietnam/app", ".html");
		...
		return Opa5.extend("vn.com.cateringvietnam.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["vn/com/cateringvietnam/localService/mockserver"], function (mockserver) {
